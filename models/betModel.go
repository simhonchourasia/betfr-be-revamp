...
type Bet struct {
	...
	NumStakesFilled        int64 // total filled staked shares
	CreatorStakedUnfilled  int64 // yet-unfilled shares staked in favour of creator
	ReceiverStakedUnfilled int64 // yet-unfilled shares staked in favour of receiver
}
